  ...
  return (
    <div className="space-y-6">
      ...
      <div className="relative">
        <Search className="absolute left-4 top-1/4 transform -translate-y-1/2 text-gray-400 w-5 h-5" />
        <Input
          type="text"
        ...
        <button
          ...
          className="text-sm text-purple-300 hover:text-white transition mt-3 ml-1"
        >
